...
#define DEFAULT_PATCH_BIAS    5.0
#define DEFAULT_PATCH_CACHE   512
#define DEFAULT_PATCH_DEPTH     3

#define DEFAULT_TEXTURE_POOL   48
#define DEFAULT_COLOR_LOD      16
#define DEFAULT_NORMAL_LOD     16
#define DEFAULT_HEIGHT_LOD     16
