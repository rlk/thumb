...
app::anaglyph::anaglyph(app::node tile,
...
bool app::anaglyph::pick(double *p, double *q, int wx, int wy)
{
    if (frustL)
    {
...
void app::anaglyph::prep(view_v& views, frustum_v& frusta)
{
